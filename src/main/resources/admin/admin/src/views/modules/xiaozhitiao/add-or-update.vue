          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="悄悄话" prop="qiaoqiaohua">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="悄悄话"
                  v-model="ruleForm.qiaoqiaohua" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiaoqiaohua" label="悄悄话" prop="qiaoqiaohua">
                    <span>{{ruleForm.qiaoqiaohua}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaotimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='qiaoqiaohua'){
            this.ruleForm.qiaoqiaohua = obj[o];
	    this.ro.qiaoqiaohua = true;
            continue;
          }
	            	            if(o=='tupianfengmian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaozhitiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaozhitiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
